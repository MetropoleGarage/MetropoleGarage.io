$( document ).ready(function() {
 ...
 // iniciando loaders quando o usuário chegar no elemento
    ...
    // steTimeout serve para carregar primeiro as imagens
    setTimeout(function() {
        $('#data-area').parallax({imageSrc: 'img/banner8.jpg'});
        $('#apply-area').parallax({imageSrc: 'img/banner3.jpg'});
    }, 600);
